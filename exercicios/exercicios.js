...
console.log(nome, idade, gostaDeProgramacao);
...
let cidade2 = "Santa Cruz do Sul";
let estado2 = "RS";
console.log(`Eu moro em ${cidade2}, ${estado2}.`);
...
let senha2 = "abcd";
let tentativa = "xyz";
while (tentativa !== senha2) {
    console.log("Senha incorreta, tente novamente.");
    tentativa = "abcd"; // Simulando a entrada correta na segunda tentativa
}
...
do {
    ...
    tentativa2 = "1234"; // Simulando a entrada correta na primeira tentativa
} while (tentativa2 !== senha3);
...
let opcao;
do {
    console.log("Menu: 1. Opção A 2. Opção B 3. Sair");
    opcao = "sair"; // Simulando a escolha de sair na primeira tentativa
} while (opcao !== "sair");
